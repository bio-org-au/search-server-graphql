...
class TaxonomySearchAcceptedNameSimpleTest < ActionController::TestCase
  ...
  test 'simple accepted name taxonomy query' do
    skip
    # post 'execute',
    # params: { query: '{taxonomy_search(search_term:"angophora costata",
    # accepted_name: true){count,taxa{id,full_name}}}' }
