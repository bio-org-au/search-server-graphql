...
class NameSearchScientificWrongPubYear4ProtoTest < ActionController::TestCase
  ...
  test 'scientific name search on wrong publication year 4 protologue' do
    post 'execute',
         params: { query: '{name_search(search_term:"angophora costata", publication_year: "1962", protologue: "1", type_of_name:"scientific"){count,names{id,full_name,name_usages{reference_usage{citation,page,page_qualifier,year,standalone}}}}}' }
