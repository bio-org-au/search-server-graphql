...
class NameSearchScientificSimpleTest < ActionController::TestCase
  ...
  test "simple scientific name search test" do
    post 'execute',
      {query: '{name_search(search_term:"angophora", type_of_name:"scientific"){names{id,full_name,name_history{name_usages{citation,page,page_qualifier,year,standalone}}}}}' }
