...
class NameSearchScientificSimpleTest < ActionController::TestCase
  ...
  test 'simple scientific name search test' do
    post 'execute',
         params: { query: '{name_search(search_term:"angophora*", scientific_name: true, scientific_autonym_name: true, scientific_named_hybrid_name: true){count,names{id,full_name,name_usages{citation,page,page_qualifier,year,standalone}}}}' }
