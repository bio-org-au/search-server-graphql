...
class NameSearchScientificWrongPublicationYearTest < ActionController::TestCase
  ...
  test 'scientific name search on wrong publication year' do
    post 'execute',
         params: { query: '{name_search(search_term:"angophora costata", publication_year: "1917", type_of_name:"scientific"){count,names{id,full_name,name_history{name_usages{citation,page,page_qualifier,year,standalone}}}}}' }
