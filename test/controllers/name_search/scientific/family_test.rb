...
class NameSearchScientificFamilyTest < ActionController::TestCase
  ...
  test 'scientific name search on family' do
    post 'execute',
         params: { query: '{name_search(family:"myrtaceae", type_of_name:"scientific"){count,names{id,full_name,name_history{name_usages{citation,page,page_qualifier,year,standalone}}}}}' }
